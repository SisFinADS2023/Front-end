...
const Banner = () => {
  return (
    <div id="sidebar-tela-login" className="relative h-screen w-[710px] bg-gradient-to-t from-[#E9F1FB] rounded-br-[50px]">
      <div className='absolute top-[60px] left-[90px]'><Image src={Logo} className=' w-[295px] h-[78px]' /></div>
      ...
      <div className='absolute relative top-[500px] left-[80px] h-[500px] w-[500px]'>
          ...
          <Image src={Frame1} className='h-auto w-auto ' />
       
          <Image src={Frame2} className='h-auto w-auto' />
        
          <Image src={Frame3} className='h-auto w-auto' />
